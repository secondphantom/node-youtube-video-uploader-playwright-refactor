...
export default class YoutubeUploader {
    ...
    uploadVideo: (input: UploadVideoInput, options?: UploadVideoOptions) => Promise<string>;
    uploadBulkVideos: (inputs: UploadBulkVideoInput) => Promise<{
        videoIds: string[];
        failInputs: UploadBulkVideoInput[];
    }>;
}
